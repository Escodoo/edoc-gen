...
#
# Generated Tue Sep 22 04:42:11 2020 by generateDS.py version 2.36.2.
# Python 3.6.9 (default, Nov  7 2019, 10:44:02)  [GCC 8.3.0]
#
# Command line options:
#   ('--no-collect-includes', '')
#   ('-f', '')
#   ('-o', '/root/generateds/edoc-gen/issnetlib/v1_00/servico_enviar_lote_rps_envio.py')
#
# Command line arguments:
#   servico_enviar_lote_rps_envio.xsd
#
# Command line:
#   /root/generateds/generateds-code/generateDS.py --no-collect-includes -f -o "/root/generateds/edoc-gen/issnetlib/v1_00/servico_enviar_lote_rps_envio.py" servico_enviar_lote_rps_envio.xsd
#
...
class EnviarLoteRpsEnvio(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd"  xmlns:dsig="http://www.w3.org/2000/09/xmldsig#" ', name_='EnviarLoteRpsEnvio', fromsubclass_=False, pretty_print=True):
        ...
        if self.LoteRps is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sLoteRps>%s</%sLoteRps>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.LoteRps), input_name='LoteRps')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'LoteRps':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'LoteRps')
            value_ = self.gds_validate_string(value_, node, 'LoteRps')
            self.LoteRps = value_
            self.LoteRps_nsprefix_ = child_.prefix
