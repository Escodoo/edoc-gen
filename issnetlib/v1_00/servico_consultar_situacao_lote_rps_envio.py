...
#
# Generated Tue Sep 22 04:42:08 2020 by generateDS.py version 2.36.2.
# Python 3.6.9 (default, Nov  7 2019, 10:44:02)  [GCC 8.3.0]
#
# Command line options:
#   ('--no-collect-includes', '')
#   ('-f', '')
#   ('-o', '/root/generateds/edoc-gen/issnetlib/v1_00/servico_consultar_situacao_lote_rps_envio.py')
#
# Command line arguments:
#   servico_consultar_situacao_lote_rps_envio.xsd
#
# Command line:
#   /root/generateds/generateds-code/generateDS.py --no-collect-includes -f -o "/root/generateds/edoc-gen/issnetlib/v1_00/servico_consultar_situacao_lote_rps_envio.py" servico_consultar_situacao_lote_rps_envio.xsd
#
