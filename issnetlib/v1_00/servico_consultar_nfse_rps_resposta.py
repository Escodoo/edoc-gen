...
#
# Generated Tue Sep 22 04:42:07 2020 by generateDS.py version 2.36.2.
# Python 3.6.9 (default, Nov  7 2019, 10:44:02)  [GCC 8.3.0]
#
# Command line options:
#   ('--no-collect-includes', '')
#   ('-f', '')
#   ('-o', '/root/generateds/edoc-gen/issnetlib/v1_00/servico_consultar_nfse_rps_resposta.py')
#
# Command line arguments:
#   servico_consultar_nfse_rps_resposta.xsd
#
# Command line:
#   /root/generateds/generateds-code/generateDS.py --no-collect-includes -f -o "/root/generateds/edoc-gen/issnetlib/v1_00/servico_consultar_nfse_rps_resposta.py" servico_consultar_nfse_rps_resposta.xsd
#
...
class ConsultarNfseRpsResposta(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd"  xmlns:None="http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_nfse_rps_resposta.xsd" ', name_='ConsultarNfseRpsResposta', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ConsultarNfseRpsResposta'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd"  xmlns:None="http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_consultar_nfse_rps_resposta.xsd" ', name_='ConsultarNfseRpsResposta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.CompNfse is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCompNfse>%s</%sCompNfse>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.CompNfse), input_name='CompNfse')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'CompNfse':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'CompNfse')
            value_ = self.gds_validate_string(value_, node, 'CompNfse')
            self.CompNfse = value_
            self.CompNfse_nsprefix_ = child_.prefix
