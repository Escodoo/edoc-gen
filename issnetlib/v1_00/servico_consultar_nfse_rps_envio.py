...
#
# Generated Tue Sep 22 04:42:06 2020 by generateDS.py version 2.36.2.
# Python 3.6.9 (default, Nov  7 2019, 10:44:02)  [GCC 8.3.0]
#
# Command line options:
#   ('--no-collect-includes', '')
#   ('-f', '')
#   ('-o', '/root/generateds/edoc-gen/issnetlib/v1_00/servico_consultar_nfse_rps_envio.py')
#
# Command line arguments:
#   servico_consultar_nfse_rps_envio.xsd
#
# Command line:
#   /root/generateds/generateds-code/generateDS.py --no-collect-includes -f -o "/root/generateds/edoc-gen/issnetlib/v1_00/servico_consultar_nfse_rps_envio.py" servico_consultar_nfse_rps_envio.xsd
#
...
class ConsultarNfseRpsEnvio(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd" ', name_='ConsultarNfseRpsEnvio', fromsubclass_=False, pretty_print=True):
        ...
        if self.IdentificacaoRps is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sIdentificacaoRps>%s</%sIdentificacaoRps>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.IdentificacaoRps), input_name='IdentificacaoRps')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'IdentificacaoRps':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'IdentificacaoRps')
            value_ = self.gds_validate_string(value_, node, 'IdentificacaoRps')
            self.IdentificacaoRps = value_
            self.IdentificacaoRps_nsprefix_ = child_.prefix
