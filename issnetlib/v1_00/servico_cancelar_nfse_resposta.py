...
#
# Generated Tue Sep 22 04:41:58 2020 by generateDS.py version 2.36.2.
# Python 3.6.9 (default, Nov  7 2019, 10:44:02)  [GCC 8.3.0]
#
# Command line options:
#   ('--no-collect-includes', '')
#   ('-f', '')
#   ('-o', '/root/generateds/edoc-gen/issnetlib/v1_00/servico_cancelar_nfse_resposta.py')
#
# Command line arguments:
#   servico_cancelar_nfse_resposta.xsd
#
# Command line:
#   /root/generateds/generateds-code/generateDS.py --no-collect-includes -f -o "/root/generateds/edoc-gen/issnetlib/v1_00/servico_cancelar_nfse_resposta.py" servico_cancelar_nfse_resposta.xsd
#
...
class CancelarNfseResposta(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd"  xmlns:None="http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_cancelar_nfse_resposta.xsd" ', name_='CancelarNfseResposta', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CancelarNfseResposta'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd"  xmlns:None="http://www.issnetonline.com.br/webserviceabrasf/vsd/servico_cancelar_nfse_resposta.xsd" ', name_='CancelarNfseResposta', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Cancelamento is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCancelamento>%s</%sCancelamento>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Cancelamento), input_name='Cancelamento')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cancelamento':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Cancelamento')
            value_ = self.gds_validate_string(value_, node, 'Cancelamento')
            self.Cancelamento = value_
            self.Cancelamento_nsprefix_ = child_.prefix
