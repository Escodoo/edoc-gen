...
#
# Generated Tue Sep 22 04:41:57 2020 by generateDS.py version 2.36.2.
# Python 3.6.9 (default, Nov  7 2019, 10:44:02)  [GCC 8.3.0]
#
# Command line options:
#   ('--no-collect-includes', '')
#   ('-f', '')
#   ('-o', '/root/generateds/edoc-gen/issnetlib/v1_00/servico_cancelar_nfse_envio.py')
#
# Command line arguments:
#   servico_cancelar_nfse_envio.xsd
#
# Command line:
#   /root/generateds/generateds-code/generateDS.py --no-collect-includes -f -o "/root/generateds/edoc-gen/issnetlib/v1_00/servico_cancelar_nfse_envio.py" servico_cancelar_nfse_envio.xsd
#
...
class CancelarNfseEnvio(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:tc="http://www.issnetonline.com.br/webserviceabrasf/vsd/tipos_complexos.xsd" ', name_='CancelarNfseEnvio', fromsubclass_=False, pretty_print=True):
        ...
        if self.Pedido is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPedido>%s</%sPedido>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Pedido), input_name='Pedido')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Pedido':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Pedido')
            value_ = self.gds_validate_string(value_, node, 'Pedido')
            self.Pedido = value_
            self.Pedido_nsprefix_ = child_.prefix
