...
# Generated Tue Sep 22 03:16:14 2020 by generateDS.py(Akretion's branch).
...
class TInutNFe(models.AbstractModel):
    ...
    nfe40_infInut = fields.Many2one(
        "nfe.40.infinut",
        string="infInut", xsd=True, xsd_required=True,
...
class TProcInutNFe(models.AbstractModel):
    ...
    nfe40_inutNFe = fields.Many2one(
        "nfe.40.tinutnfe",
        string="inutNFe", xsd=True, xsd_required=True)
    nfe40_retInutNFe = fields.Many2one(
        "nfe.40.tretinutnfe",
        string="retInutNFe", xsd=True, xsd_required=True)
...
class InfInut(models.AbstractModel):
    ...
    nfe40_xServ = fields.Selection(
        XSERV_INFINUT,
        string="Serviço Solicitado", xsd=True, xsd_required=True)
    ...
    nfe40_CNPJ = fields.Char(
        string="CNPJ do emitente", xsd=True, xsd_required=True)
    ...
    nfe40_serie = fields.Char(
        string="Série da NF-e", xsd=True, xsd_required=True)
