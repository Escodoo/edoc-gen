...
# Generated Tue Sep 22 03:16:19 2020 by generateDS.py(Akretion's branch).
...
class ICMS90(models.AbstractModel):
    ...
    nfe40_vBCFCPST = fields.Monetary(
        currency_field="brl_currency_id",
        digits=2, string="Valor da Base de cálculo do FCP. (vBCFCPST)",
        xsd=True)
    nfe40_pFCPST = fields.Monetary(
        currency_field="brl_currency_id",
        digits=2,
...
class ICMSST(models.AbstractModel):
    ...
    nfe40_vICMSSTDest = fields.Monetary(
        currency_field="brl_currency_id",
        digits=2, string="vICMSSTDest", xsd=True, xsd_required=True,
...
class Prod(models.AbstractModel):
    ...
    nfe40_cEANTrib = fields.Char(
        string="GTIN (cEANTrib)", xsd=True, xsd_required=True,
